...
%        but, in that case, set carefully the MBB and ParBoot parameters
%        (check the block length, etc., since internal variables and scripts have been 
%        tested for hourly data)
%          
...
% n_boot - (int) Number of bootstrap resamples used to geneate the distributions
%
%
% OPTIONS:
% 'method'/'mtd',  -
