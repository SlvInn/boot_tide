...
[h,t] = read_hourly_data('./data/hobs_HAL_1999_2009.mat',t0,te); % water level and time @ Halifax


% load some reconstructions at these two stations (from HA)
[hhat,that] = read_hourly_data('./data/hhat_HAL_2000.mat',t0,te); % estimated water level and time @ Halifax
